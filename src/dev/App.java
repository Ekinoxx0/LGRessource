...
public class App {
	...
	private static final List<String> deleteItems = Arrays.asList("compass", "clock", "banner", "bow", "leather", "slot", "potion", "tipped", "spectral", "enchanted", "nether_star", "spawn", "end_crystal", "gray_stained_glass_pane");
	private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
	private static final String comment = "Generated by LGRessource by Ekinoxx";
	
	private static final File generatedAssets = new File("D:\\Files\\Scolaire\\workspace\\RessourcePackGenerator\\target\\generated\\assets\\minecraft");
	...
	private void generate() throws IOException {
		...
		FileUtils.copyFile(new File(thisFolder, "pack.mcmeta"), new File(generatedFolder, "pack.mcmeta"));
