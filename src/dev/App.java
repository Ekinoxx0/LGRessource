...
public class App {
	...
	private static final List<String> deleteItems = Arrays.asList("melon", "boat", "map", "compass", "clock", "banner", "bow", "leather", "slot", "potion", "tipped", "spectral", "enchanted", "nether_star", "spawn", "end_crystal", "gray_stained_glass_pane");
	...
	private void generate() throws IOException {
		...
		//Success!
		System.out.println();
		System.out.println("Deleting old zips...");
		File generatedZip = new File(generatedFolder.getParentFile(), "generated.zip");
		File generatedZip13 = new File(generatedFolder.getParentFile(), "generated-pre13.zip");
		if(generatedZip.exists())
			FileUtils.forceDelete(generatedZip);
		if(generatedZip13.exists())
			FileUtils.forceDelete(generatedZip13);
		System.out.println("Generated folder successfuly. Zipping it...");
		ZipUtil.pack(generatedFolder, generatedZip);
		ZipUtil.pack(pre13, generatedZip13);
		System.out.println("Ziiiiiipppppedd!");
		System.out.println("Deleting generated folders...");
